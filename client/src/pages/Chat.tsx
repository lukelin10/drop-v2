  ...
  return (
    <section className="flex flex-col h-screen pt-0 bg-[hsl(var(--warm-cream))]">
      ...
      <div className="flex-1 flex flex-col mx-4 rounded-2xl overflow-hidden bg-white border border-border/10 shadow-sm mb-4">
        ...
        <div className="flex-1 overflow-y-auto py-4 px-4 bg-[hsl(var(--warm-cream))]" id="chat-messages">
          <div className="space-y-4 max-w-md mx-auto">
            {/* Initial user question label */}
            <div className="text-center mb-3">
              <span className="text-[11px] font-medium bg-[hsl(var(--warm-cream))] text-primary px-3 py-1 rounded-full border border-primary/10">
                Your reflection
              </span>
            </div>
            ...
            {isLimitReached ? (
              ...
              <form className="flex items-center space-x-2" onSubmit={handleSendMessage}>
                <div className="relative flex-1">
                  <Textarea 
                    className="w-full bg-[hsl(var(--warm-cream))] border border-border/10 rounded-full p-3 text-xs resize-none focus-visible:ring-1 focus-visible:ring-primary/30 focus-visible:ring-offset-0 min-h-0 h-10 py-2.5 pr-10 shadow-sm"
